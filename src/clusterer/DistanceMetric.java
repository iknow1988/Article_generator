package clusterer;
/**
 * Abstract class for measuring distances between documents, clusters and
 * clusterLists. Here distance determines the similarity of objects. The more
 * similar two objects the smaller the distance between them.
 */
public abstract class DistanceMetric {
	...
	/**
	 * Calculate the minimum distance between a document and the centroids of
	 * the clusters within a clusterList.
	 */
